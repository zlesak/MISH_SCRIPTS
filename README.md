...
~~~~
last change: 06.03.2026 by j.zlesak - only BE/FE redeployment scripts
previous change: 19.02.2026 by j.zlesak - dev env var update, nginx vaadin web socket upgrade enabled
~~~~
